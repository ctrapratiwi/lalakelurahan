...
<title>Informasi Kasus Covid'19 Provinsi Bali</title>
    ...
    <div class="row info">
        ...
        <div class="row info">
        	...
        	<div class="card" style="width: 80rem;">
              ...
              <div class="card-body">
                    <h5 class="card-title">Peta Penyebaran Covid'19 Provinsi Bali</h5>
              </div>
    	...
    	<div class="row text col-lg-12">
        	<div class="col-lg-6">@NirmalaDewi</div>
            <div class="col-lg-6 text-right">Peta Penyebaran Covid'19 Provinsi Bali</div>
        </div>
